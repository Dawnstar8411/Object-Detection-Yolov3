...
if __name__ == "__main__":
    ...
    if args.is_gt:
        ...
        class_names = load_classes(
            data_config["names"])  # list of all class names，in the same numbering order as the annotaion
    ...
    for i, (path, detections) in enumerate(zip(img_path_list, img_detections)):
        ...
        if detections is not None:
            ...
            for x1, y1, x2, y2, conf, cls_conf, cls_pred in detections:
                ...
                color = bbox_colors[int(cls_pred)]  # color of rectangle
    ...
    # colors = [cmap(i) for i in np.linspace(0, 1, 5)]
    # bbox_colors = random.sample(colors, 2)
# [(0.2235294117647059, 0.23137254901960785, 0.4745098039215686, 1.0), (0.9058823529411765, 0.5882352941176471, 0.611764705882353, 1.0)]
